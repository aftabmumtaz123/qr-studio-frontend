...
const ModalQRPreview = ({ qr }) => {
  ...
  useEffect(() => {
    ...
    import('qr-code-styling').then((module) => {
      ...
      const encodedData = getPublicQRUrl(qr) || 'https://example.com';
...
const QRCard = ({ qr, onDelete, onUpdate, onToggle, onView }) => {
  ...
  const shortUrl=getPublicQRUrl(qr); const tone=typeColors[qr.type]||'gray';
