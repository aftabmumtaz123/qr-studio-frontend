      ...
      return (
        <div className="space-y-3 w-full">
          <div className="flex items-center gap-3">
            ...
            {cardStyle.brandLogo && (
              <img
                src={cardStyle.brandLogo}
                alt="Logo"
                className="w-9 h-9 object-contain ml-auto shrink-0"
              />
            )}
          </div>
      ...
      <div className="space-y-2.5 w-full">
        ...
        <div>
          ...
          <h3 className="text-base font-extrabold leading-snug">
            {cardData.subtitle || "Visit Our Website"}
          </h3>
        </div>
      ...
      return (
        <div className="p-6 space-y-4 bg-gradient-to-br from-slate-900 via-slate-850 to-slate-950 text-slate-100 rounded-2xl border border-amber-500/30 shadow-2xl">
          <div className="flex items-center justify-between border-b border-amber-500/20 pb-3">
            ...
            <span className="text-[9px] px-2 py-0.5 rounded bg-amber-500/10 text-amber-300 font-mono border border-amber-500/20">
              VERIFIED
            </span>
          </div>
      ...
      return (
        <div className="p-5 text-center space-y-3.5 bg-surface-900 text-slate-100 rounded-2xl border-2 border-brand-500/40 shadow-2xl relative">
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="text-[10px] uppercase font-bold px-2.5 py-0.5 rounded-full bg-gray-100 text-gray-500 border border-gray-300 mt-0.5">
              {cardData.title || "CEO & Founder"}
            </span>
          </div>
      ...
      return (
        <div className="p-5 space-y-3.5">
          <div className="flex items-center justify-between border-b pb-2.5 border-slate-200 dark:border-slate-700">
            ...
            <span className="text-[9px] font-bold px-2 py-0.5 rounded bg-slate-100 dark:bg-slate-800 opacity-80">
              VERIFIED CARD
            </span>
          </div>
          {renderCardDetails()}
